...
def get_args():
    ...
    parser.add_argument('--env_name', type=str, default='PandaReach-v2', help='the environment name')
    #parser.add_argument('--env_name', type=str, default='PandaPickAndPlace-v2', help='the environment name')
    ...
    parser.add_argument('--n_epochs', type=int, default=100, help='the number of epochs to train the agent')
    parser.add_argument('--n_cycles', type=int, default=50, help='the times to collect samples per epoch')
    parser.add_argument('--n_steps', type=int, default=4020)
